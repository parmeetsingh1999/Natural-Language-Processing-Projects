...
max_features = 10000
sequence_length = 250
vectorize_layer = TextVectorization(standardize = customStandardization, max_tokens = max_features, output_mode = 'int', output_sequence_length = sequence_length)
...
train_ds = raw_train_ds.map(vectorizeText)
val_ds = raw_val_ds.map(vectorizeText)
test_ds = raw_test_ds.map(vectorizeText)
